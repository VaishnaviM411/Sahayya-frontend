...
class _ForumState extends State<Forum> {
  ...
  Widget build(BuildContext context) {
    ...
    for (var i = 0; i < thread.length; i++) {
      chats.add(LineOfChat(
        username: theValue[i]['username'],
        message: theValue[i]['message'],
        isMe: theValue[i]['username'] == widget.theUsername,
      ));
...
class LineOfChat extends StatelessWidget {
  ...
  LineOfChat(
      {required this.username, required this.message, required this.isMe});
