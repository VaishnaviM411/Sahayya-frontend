...
import 'dart:io';
import 'dart:convert';
import 'package:sahayya/Company/components/textNonEdit.dart';
    ...
    return Container(
        ...
        child: Row(
          ...
          children: [
            ElevatedButton(
              ...
              onPressed: () async {
                         Map<String, dynamic> theData = {"coOrdinates": {
                      "latitude": latitude,
                       "longitude": longitude
             }};
                         ...
                         if(response.statusCode == 200){
                           ...
                           Navigator.pushReplacementNamed(context, '/companyDonor');
                           return;
                         }
                         else{
                           final snackBar = SnackBar(
            ...
            Padding(
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  Navigator.pushReplacementNamed(context, '/editCompanyProfile');
                },
              ),
            ),
          ],
      ...
      SizedBox(
        height: 20,
              ...
              TextNonEdit(label: 'Contact Number ', text: '${widget.entityData['contactNo']}'),
              SizedBox(
                  height:20,
              ),
